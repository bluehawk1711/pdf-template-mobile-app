...
const INGREDIENT_LINES = [
  { text: 'Calcitriol is active form of Vitamin D3, enhance the calcium absorption from Intestine.', pink: false },
  { text: 'Methylcobalamin reduces the hyper homo-cystene level.', pink: false },
  { text: 'Folic acid helps in production of blood in the body.', pink: false },
  { text: 'Omega-3-Fatty acids is esential for the development of the brain, nerves and improves the health of heart.', pink: true },
  ...
  useEffect(() => {
    Animated.sequence([
      ...
      Animated.parallel([
        ...
        Animated.timing(boxOp, { toValue: 1, duration: 600, delay: 150, useNativeDriver: true }),
      ]),
      Animated.parallel([
        Animated.timing(toOp, { toValue: 1, duration: 500, useNativeDriver: true }),
        Animated.timing(toY, { toValue: 0, duration: 500, useNativeDriver: true }),
      ]),
    ]).start();
  }, [titleOp, titleY, womanOp, womanSc, rxOp, brOp, brX, tmOp, cpOp, cpY, boxOp, toOp, toY]);
  ...
  return (
    <View style={styles.screen}>
      ...
      <Animated.View style={{
        ...
        <Text style={{
          fontFamily: CURSIVE, fontSize: fTitle1, fontWeight: '800',
          color: MAROON, fontStyle: 'italic', lineHeight: fTitle1 * 1.3,
        }}>
      ...
      {/* "with" — cursive italic */}
      <Animated.View style={{
        position: 'absolute', left: bL + bW * 0.02, top: bT + bH * 0.14,
        opacity: titleOp, transform: [{ translateY: titleY }],
      }}>
        <Text style={{
          fontFamily: CURSIVE, fontSize: fTitle2, fontWeight: '800',
          color: MAROON, fontStyle: 'italic',
        }}>
          with
        </Text>
      </Animated.View>
      ...
      <Animated.View style={{
        position: 'absolute', left: bL + bW * 0.02, top: bT + bH * 0.18,
        opacity: titleOp, transform: [{ translateY: titleY }],
      }}>
        <Text style={{
          fontFamily: CURSIVE, fontSize: fTitle2, fontWeight: '800',
      ...
      <Animated.View style={{
        position: 'absolute', left: bL + bW * 0.02, top: bT + bH * 0.70,
        width: womanW, alignItems: 'center',
        opacity: titleOp, transform: [{ translateY: titleY }],
      }}>
        <Text style={{
          fontFamily: CURSIVE, fontSize: fTitle2, fontWeight: '700',
          color: MAROON, fontStyle: 'italic',
        }}>
          ....may lead to
        </Text>
      ...
      <Animated.View style={{
        position: 'absolute', left: bL + bW * 0.02, top: bT + bH * 0.76,
        width: womanW, alignItems: 'center',
        opacity: titleOp, transform: [{ translateY: titleY }],
      }}>
        <Text style={{
          fontFamily: CURSIVE, fontSize: fTitle1, fontWeight: '700',
          color: MAROON, fontStyle: 'italic',
        }}>
          Osteoporosis
        </Text>
      ...
      <Animated.View style={{
        ...
        <Text style={{ fontFamily: SERIF, fontSize: fBrand, fontWeight: '700', color: MAROON }}>
          Qutocal
        </Text>
        <View style={{
          ...
          <Text style={{
            fontFamily: SANS, fontSize: fMax, fontWeight: '800', color: '#FFFFFF',
          }}>
            MAX
          </Text>
        </View>
      ...
      <Animated.View style={{
        ...
        <Text style={{ fontFamily: SANS, fontSize: fTm, color: MAROON }}>{'®'}</Text>
      </Animated.View>
      ...
      <Animated.View style={{
        ...
        <Text style={{
          fontFamily: SANS, fontSize: fComp, fontWeight: '600', color: GRAY,
      ...
      <Animated.View style={{
        position: 'absolute', left: bL + bW * 0.52, top: bT + bH * 0.34,
        ...
        {INGREDIENT_LINES.map((item, i) => (
          <Text key={i} style={{
            fontFamily: SANS, fontSize: fIngT, color: item.pink ? PINK_TEXT : DARK,
            fontWeight: '600',
      ...
      <Animated.View style={{
        position: 'absolute', left: bL + bW * 0.52, top: bT + bH * 0.90,
        opacity: toOp, transform: [{ translateY: toY }],
      }}>
        <Text style={{
          fontFamily: CURSIVE, fontSize: fTune, fontWeight: '800',
